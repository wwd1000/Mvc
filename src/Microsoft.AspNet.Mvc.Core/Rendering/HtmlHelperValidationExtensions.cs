...
namespace Microsoft.AspNet.Mvc.Rendering
{
    ...
    public static class HtmlHelperValidationExtensions
    {
        ...
        /// <see cref="StringHtmlContent.Empty"/> if the current model is valid and client-side validation is disabled).
        /// </returns>
        ...
        /// <paramref name="message"/>) and the &lt;ul&gt; element. <see cref="StringHtmlContent.Empty"/> if the current model
