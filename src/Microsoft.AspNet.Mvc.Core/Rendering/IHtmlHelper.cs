...
namespace Microsoft.AspNet.Mvc.Rendering
{
    ...
    public interface IHtmlHelper
    {
        ...
        /// &lt;form&gt; is submitted.
        /// </summary>
        /// <returns>A new <see cref="IHtmlContent"/> containing the &lt;hidden&gt; element.</returns>
        ...
        /// <returns>
        /// A <see cref="Task"/> that on completion returns a new <see cref="IHtmlContent"/> containing
        /// the created HTML.
        /// </returns>
        ...
        /// <summary>
        /// Wraps HTML markup in an <see cref="IHtmlContent"/>, without HTML-encoding the specified
        /// <paramref name="value"/>.
        /// </summary>
        ...
        /// <see cref="IHtmlContent"/>, without HTML-encoding the string representation.
        /// </summary>
        /// <param name="value">The <see cref="object"/> to wrap.</param>
        /// <returns>A new <see cref="IHtmlContent"/> containing the wrapped string representation.</returns>
        ...
        /// and the &lt;ul&gt; element. <see cref="StringHtmlContent.Empty"/> if the current model is valid and client-side
