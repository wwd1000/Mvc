...
namespace Microsoft.AspNet.Mvc.ModelBinding
{
    public class ModelValidationNodeTest
    {
        ...
        public void Validate_Ordering()
        {
            ...
            var childMetadata = provider.GetMetadataForType(model.GetType()); // **** GetMetadataForProperty ... "ValidStringProperty"
        ...
        public void Validate_ChildNodes_OverridesOrdering()
        {
            ...
            var modelMetadata = provider.GetMetadataForType(model.GetType());
        ...
        {
            return null; // **** new EmptyModelMetadataProvider().GetMetadataForType(null, typeof(object));
        }

        private static ModelMetadata GetModelMetadata(object model)
        {
            return null; // **** new DataAnnotationsModelMetadataProvider().GetMetadataForType(() => model, model.GetType());
        }

        private static ModelMetadata GetModelMetadata(Type type)
        {
            return null; // **** new DataAnnotationsModelMetadataProvider().GetMetadataForType(modelAccessor: null, modelType: type);
        }
            ...
            IModelMetadataProvider metadataProvider = null)
        {
            ...
            return new ModelValidationContext(
                ...
                modelExplorer: metadataProvider.GetModelExplorerForType(metadata.ModelType, model: null));
        }
